...
void StEpdEpInfo::SetIsGoodEast(bool isgood) { mIsGood[0] = isgood; }
void StEpdEpInfo::SetIsGoodWest(bool isgood) { mIsGood[1] = isgood; }
bool StEpdEpInfo::GetIsGoodEast() const { return mIsGood[0]; }
bool StEpdEpInfo::GetIsGoodWest() const { return mIsGood[1]; }
bool StEpdEpInfo::GetIsGoodFull() const { return (mIsGood[0] || mIsGood[1]); }
bool StEpdEpInfo::GetIsGoodBoth() const { return (mIsGood[0] && mIsGood[1]); }
