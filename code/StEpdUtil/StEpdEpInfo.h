...
class StEpdEpInfo{
 ...
 public:
  ...
  void SetIsGoodEast(bool isgood);
  void SetIsGoodWest(bool isgood);
  void SetIsGoodFull(bool isgood);
  void SetIsGoodBoth(bool isgood);
  bool GetIsGoodEast() const;
  bool GetIsGoodWest() const;
  bool GetIsGoodFull() const;
  bool GetIsGoodBoth() const;
